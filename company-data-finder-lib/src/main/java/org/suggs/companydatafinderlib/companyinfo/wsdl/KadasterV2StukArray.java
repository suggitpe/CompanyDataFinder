...
/**
 * <p>Java class for KadasterV2StukArray complex type.
 * 
...
@XmlType(name = "KadasterV2StukArray", propOrder = {
    "item"
})
public class KadasterV2StukArray {

    protected List<KadasterV2Stuk> item;
     ...
     * 
     */
    public List<KadasterV2Stuk> getItem() {
        if (item == null) {
            item = new ArrayList<KadasterV2Stuk>();
        }
        return this.item;
    }
