...
/**
 * <p>Java class for CompliancePersonSearchReferencePagedResult complex type.
 * 
...
@XmlType(name = "CompliancePersonSearchReferencePagedResult", propOrder = {

})
public class CompliancePersonSearchReferencePagedResult {

    @XmlElement(required = true)
    protected ResultInfo paging;
    @XmlElement(required = true)
    protected CompliancePersonSearchReferenceArray results;
     ...
     * @return
     *     possible object is
     *     {@link CompliancePersonSearchReferenceArray }
     *     
     */
     ...
     *     
     */
    public void setResults(CompliancePersonSearchReferenceArray value) {
        this.results = value;
    }
