...
/**
 * <p>Java class for DutchBusinessNewsItemPagedResult complex type.
 * 
...
@XmlType(name = "DutchBusinessNewsItemPagedResult", propOrder = {

})
public class DutchBusinessNewsItemPagedResult {

    @XmlElement(required = true)
    protected ResultInfo paging;
    @XmlElement(required = true)
    protected DutchBusinessNewsItemArray results;
     ...
     * @return
     *     possible object is
     *     {@link DutchBusinessNewsItemArray }
     *     
     */
    public DutchBusinessNewsItemArray getResults() {
        return results;
    }
     ...
     *     
     */
    public void setResults(DutchBusinessNewsItemArray value) {
        this.results = value;
    }
