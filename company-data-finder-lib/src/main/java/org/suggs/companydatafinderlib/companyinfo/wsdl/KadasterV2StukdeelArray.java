...
/**
 * <p>Java class for KadasterV2StukdeelArray complex type.
 * 
...
@XmlType(name = "KadasterV2StukdeelArray", propOrder = {
    "item"
})
public class KadasterV2StukdeelArray {

    protected List<KadasterV2Stukdeel> item;
     ...
     * 
     */
    public List<KadasterV2Stukdeel> getItem() {
        if (item == null) {
            item = new ArrayList<KadasterV2Stukdeel>();
        }
        return this.item;
    }
