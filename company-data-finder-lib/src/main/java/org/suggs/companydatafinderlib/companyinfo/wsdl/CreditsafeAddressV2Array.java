...
/**
 * <p>Java class for CreditsafeAddressV2Array complex type.
 * 
...
@XmlType(name = "CreditsafeAddressV2Array", propOrder = {
    "item"
})
public class CreditsafeAddressV2Array {

    protected List<CreditsafeAddressV2> item;
     ...
     * 
     */
    public List<CreditsafeAddressV2> getItem() {
        if (item == null) {
            item = new ArrayList<CreditsafeAddressV2>();
        }
        return this.item;
    }
